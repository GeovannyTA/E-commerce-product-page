/* Cambio en el contador de prodcutos */
...
//Agregar el total de productos al presionar el boton add to cart
...
const carIconBtn = document.querySelector('.header__cart');
...
//Cambiar imagenes cuando presionen los botones flecha
...
//Mostrar el modal de imagenes cuando hago clic en la imagen principal
...
//Cambiar las imagenes principales desde los thumbmnails
...
//Mostrar el navbar cunado presiono el menu de hamburguesa
...
function drawProductInModal(){
    productContainer.innerHTML = `
        <div class="cart-modal__details-container">
            ...
            <div>
                <p class="cart-modal__product">Autum Limited Edition.
                <p>
                <p class="cart-modal__price">$125 x3 <span>$375.00</span></p>
            </div>
            <img class="cart-modal__delete" src="./images/icon-delete.svg" alt="delete">
        </div>
        <button class="cart-modal__checkout">Chekout</button>`;
    deleteProduct();
    let priceModal = document.querySelector('.cart-modal__price');
